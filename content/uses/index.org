...
| Static Site Generator | [[https://gitbay.org/krz/orgo][orgo]] + [[https://gitbay.org/cmc/cleberg.net/blob/main/build.py][build.py]]       | Org-mode source compiles to plaintext HTML. Single binary, no runtime.                              |
...
| Git Host              | [[https://gitbay.org/cmc][GitBay]] + [[https://github.com/ccleberg][GitHub]]       | GitBay is the primary and GitHub is the mirror.                                                     |
| CI/CD                 | [[https://gitbay.org/cmc/cleberg.net/blob/main/build.py][build.py]]              | A Python script and SSH. No pipeline to depend on.                                                  |
