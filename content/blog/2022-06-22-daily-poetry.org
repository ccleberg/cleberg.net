...
#+title:       Daily Poetry via Cron
#+description: A Python script that emails you a poem every morning via cron.
#+slug:        daily-poetry
#+filetags:    :personal:
...
[[https://github.com/krazywarez/daily-poem][daily-poem.git]].
