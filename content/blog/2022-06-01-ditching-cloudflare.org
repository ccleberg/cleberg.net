...
#+title:       Ditching Cloudflare
#+description: Why I moved my DNS away from Cloudflare, and how I did it.
#+slug:        ditching-cloudflare
#+filetags:    :privacy:security:
...
hosting [[/blog/nginx-reverse-proxy.html][my own reverse proxy with Nginx]]. With the recent additions of Unifi
