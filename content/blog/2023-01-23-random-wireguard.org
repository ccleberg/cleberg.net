...
#+title:       Random Mullvad WireGuard on Startup
#+description: A startup script to connect to a random Mullvad WireGuard server.
#+slug:        random-wireguard
#+filetags:    :linux:security:self-hosting:
