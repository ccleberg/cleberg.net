...
#+title:       Hare Lang: Notes from First Contact
#+description: First impressions of the Hare programming language.
#+slug:        exploring-hare
#+filetags:    :linux:
...
In order to play with the language, I created [[https://gitbay.org/cmc/learn/tree/main/hare][learn/hare]] and will be putting any
