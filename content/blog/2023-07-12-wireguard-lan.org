...
#+title:       Mullvad WireGuard with LAN Access
#+description: Modifying Mullvad WireGuard configs to allow LAN access while connected.
#+slug:        wireguard-lan
#+filetags:    :security:self-hosting:
