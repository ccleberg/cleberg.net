...
#+title:       Data Analysis: Finding the Best Location for a Business
#+description: Part of my data analysis course, I built an algorithm to find the best location for a new business in Lincoln.
