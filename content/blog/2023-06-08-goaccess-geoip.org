...
#+title:       Nginx Traffic Analysis with GoAccess and GeoIP
#+description: Using GoAccess with MaxMind GeoIP to analyze Nginx traffic in real time.
#+slug:        goaccess-geoip
#+filetags:    :self-hosting:web:
