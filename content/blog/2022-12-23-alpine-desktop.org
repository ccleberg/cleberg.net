...
#+title:       Alpine Desktop with Sway
#+description: Setting up Alpine Linux as a desktop with Sway as the window manager.
#+slug:        alpine-desktop
#+filetags:    :linux:
...
stored from prior desktops, such as my [[https://gitbay.org/cmc/dotfiles][dotfiles]].
